...
UX_STEP_NOCB(ux_menu_ready_step_bitcoin, pnn, {&C_bitcoin_logo, "Babylon", "BTC Staking"});
UX_STEP_NOCB(ux_menu_ready_step_bitcoin_testnet,
             pnn,
             {&C_bitcoin_logo, "Babylon", "BTC Staking"});
...
UX_STEP_NOCB(ux_menu_info_step, bn, {"Tomo Wallet", "(c) 2024 PAXT"});
